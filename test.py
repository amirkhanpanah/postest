...
def screenshot():
    ...
    try:
        ...
        log_step("اسکرین‌شات", success=False, details=str(e))
...
def report_last():
    try:
        d(text="تنظیمات").click()
        log_step("باز کردن تنظیمات")
        time.sleep(0.5)
        d(text="گزارش ها").click()
        log_step("ورود به گزارش‌ها")
        time.sleep(0.5)
        subprocess.run([adb_path, "shell", "input", "text", "1111"])
        log_step("وارد کردن رمز 1111")
        time.sleep(0.5)
        if d(text="چاپ آخرین تراکنش").exists:
            d(text="چاپ آخرین تراکنش").click()
        elif d(text="چاپ مجدد رسید آخرین تراکنش").exists:
            d(text="چاپ مجدد رسید آخرین تراکنش").click()
        log_step("چاپ آخرین تراکنش")
        time.sleep(0.5)
        if d(textContains="چاپ مجدد").exists:
            d(textContains="چاپ مجدد").click()
        log_step("چاپ مجدد")
        time.sleep(0.5)
        runapp()
    except Exception as e:
...
def report_daily():
    try:
        ...
        log_step("وارد کردن رمز 1111")
        time.sleep(0.5)
        d(text="گزارش روزانه").click()
        d(text="چاپ مجدد رسید آخرین تراکنش").click() 
        log_step("گزارش روزانه")
        time.sleep(0.5)
        d(text="چاپ کامل").click()
        log_step("چاپ")
        time.sleep(0.5)
        runapp()
    except Exception as e:
...
def report_general():
    try:
        ...
        log_step("وارد کردن رمز 1111")
        time.sleep(0.5)
        d(text="گزارش سرجمع").click()
        log_step("گزارش سرجمع")
        time.sleep(0.5)
        d(text="تایید").click()
        log_step("تایید")
        time.sleep(0.5)
        d(text="چاپ سرجمع").click()    
        log_step("چاپ")
        time.sleep(0.5)
        runapp()
    except Exception as e:
...
def configuration_show():
    try:
        ...
        log_step("باز کردن تنظیمات")
        time.sleep(1)
        d(text="مدیریت دستگاه").click()
        log_step("ورود به مدیریت دستگاه")
        subprocess.run([adb_path, "shell", "input", "text", "1111"])
        log_step("وارد کردن رمز 1111")
        time.sleep(0.5)
        d(text="مشخصات پیکربندی").click()
        log_step("مشخصات پیکربندی")
        time.sleep(0.5)
        d(text="چاپ پیکربندی").click() 
        log_step("چاپ")
        if d(textContains="بله").exists:
            d(textContains="بله").click()
        time.sleep(0.5)
        runapp()
    except Exception as e:
...
def configuration_receive():
    try:
        ...
        log_step("باز کردن تنظیمات")
        time.sleep(0.5)
        d(text="پشتیبانی").click()
        log_step("باز کردن پشتیبانی")
        # زمان معکوس
        ...
        log_step("وارد شدن به پشتیبانی")
        time.sleep(0.5)
        d(text="دریافت پیکربندی").click()
        log_step("دریافت پیکربندی")
        time.sleep(5)
        runapp()
    except Exception as e:
